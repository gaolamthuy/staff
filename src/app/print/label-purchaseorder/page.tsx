/**
 * Trang In tem nhập hàng
 * Hiển thị danh sách sản phẩm cho việc in tem nhập hàng
 */
...
/**
 * Trang In tem nhập hàng - Hiển thị danh sách sản phẩm
 */
export default async function LabelPurchaseOrderPage() {
